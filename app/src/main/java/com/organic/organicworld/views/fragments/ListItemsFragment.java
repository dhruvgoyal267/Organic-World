package com.organic.organicworld.views.fragments;
...
public class ListItemsFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    public ListItemsFragment(TYPE type, String title) {
        this.title = title;
        this.type = type;
    }
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        switch (type) {
            ...
            case Search:
                ...
                break;
            case All:
                viewModel.getAllProducts().observe(getViewLifecycleOwner(), this::updateProgressBar);
        }
